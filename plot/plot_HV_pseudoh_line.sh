...
gmt makecpt -Chaxby  -T-100/200 -Z >g1.cpt
gmt begin guangdong_psudo_h_line2 png
	...
	gmt grdtrack -Gpseudo_h.grd -E$B1 | gmt plot -J$J -W4p,black
	gmt grdtrack -Gpseudo_h.grd -E$B2 | gmt plot -J$J -W4p,black
	gmt grdtrack -Gpseudo_h.grd -E$B3 | gmt plot -J$J -W4p,black
	gmt grdtrack -Gpseudo_h.grd -E$B4 | gmt plot -J$J -W4p,black
	gmt text lines_name -D0.6/0.6 -F+f30p 
	gmt plot didiaoyuan_fault.dat -W4p,red
	gmt colorbar -Cg1.cpt -Ba100f50
