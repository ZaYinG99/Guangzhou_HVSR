...
gmt makecpt -Chaxby -T0/60/0.5 -D -V -F -Z > HVp.cpt
gmt begin guangdong_HV_Kvalue png
...
#	gmt greenspline $FI -R$RANGE -I0.0002+e/0.0002+e -G$GRD 
	gmt grdimage $GRD -J$J -t50 -E500 -CHVp.cpt
