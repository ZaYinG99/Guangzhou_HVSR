J=m100c
R1=113.248333333/113.418333333/22.8075/23.375
R2=0/20/-50/80
B1=113.33/23.05
E1=113.33/23.21
B2=113.290/23.330
...
gmt begin line3 png
	...
	gmt basemap -J$J -R$R1 -Ba0.1f0.02
	...
	gmt basemap -R$R2 -BWS -Bxa5f1+l"Distance along the @;red;Line3 profile@;; (km)" -Bya10f10g20+l"Elevation (m)"
